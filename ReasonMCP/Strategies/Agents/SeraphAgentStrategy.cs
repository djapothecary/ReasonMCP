...
{
    public class SeraphAgentStrategy : IChatStrategy
    {
        ...
        private readonly ILogger<SeraphAgentStrategy> _logger;
        ...
        )
        {
            ...
            _historyDirectory = _settings.SeraphHistoryDirectory;
            _contextFileName = _settings.SeraphCurrentContextFilename;
            _masterHistoryFilename = _settings.SeraphHistoryFilename;
            _fileExtension = _settings.HistoryFileExtension;

            //  Agent Identity
            _self = _settings.SeraphParticipantId;
            _agentId = _settings.SeraphParticipantId;
        }
        ...
        public string GenerateCurrentContextFilePath()
        {
            ...
            //  Builds: "SeraphContext_2026_06_06_143800_a1b2c3d4.jsonl"
        ...
        {
            //  Builds: "masterSeraphHistory.jsonl"
        ...
        {
            return agent.Equals(_settings.SeraphParticipantId, StringComparison.OrdinalIgnoreCase);
        }

        public bool ShouldSummarize(int turnCount)
        {
            return turnCount > _settings.SeraphSummarizationThreshold;
        }
        ...
        {
            var summaryThreshold = _settings.SeraphSummarizationThreshold;
