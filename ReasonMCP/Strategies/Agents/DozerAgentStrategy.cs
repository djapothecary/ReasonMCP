...
{
    public class DozerAgentStrategy : IChatStrategy
    {
        private readonly ChatHistoryService _chatHistoryService;
        private readonly CurrentChatContextSummarizer _currentContextSummarizer;
        private readonly DozerAgent _dozerAgent;
        private ChatSettings _settings;
        private readonly ILogger<DozerAgentStrategy> _logger;
        ...
        )
        {
            ...
            _historyDirectory = _settings.DozerHistoryDirectory;
            _contextFileName = _settings.DozerCurrentContextFilename;
            _masterHistoryFilename = _settings.DozerHistoryFilename;
            _fileExtension = _settings.HistoryFileExtension;

            //  Agent Identity
            _self = _settings.DozerParticipantId;
            _agentId = _settings.DozerParticipantId;
        }
        ...
        public string GenerateCurrentContextFilePath()
        {
            ...
            //  Builds: "DozerContext_2026_06_06_143800_a1b2c3d4.jsonl"
        ...
        {
            //  Builds: "masterDozerHistory.jsonl"
        ...
        {
            return agent.Equals(_settings.DozerParticipantId, StringComparison.OrdinalIgnoreCase);
        }

        public bool ShouldSummarize(int turnCount)
        {
            return turnCount > _settings.DozerSummarizationThreshold;
        }
        ...
        {
            var summaryThreshold = _settings.DozerSummarizationThreshold;
