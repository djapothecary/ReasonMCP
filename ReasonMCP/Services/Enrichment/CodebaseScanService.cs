...
{
    public class CodebaseScanService : ICodebaseScanService
    {
        private readonly IServiceScopeFactory _scopeFactory;
        private readonly CodebaseScanSettings _settings;
        private readonly ILogger<CodebaseScanService> _logger;
        ...
        /// <summary>
        /// Scans Codebase locations based on Settings in
        ...
        {
            var rootDirectories = _settings.RootDirectories;
